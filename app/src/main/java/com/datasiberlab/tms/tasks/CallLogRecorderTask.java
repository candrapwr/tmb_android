...
import com.datasiberlab.tms.CommonParams;
import com.datasiberlab.tms.database.AppDatabase;
import com.datasiberlab.tms.database.CallLog;
import com.datasiberlab.tms.database.CallLogDao;
import com.datasiberlab.tms.http.Http;
import com.datasiberlab.tms.http.HttpCallback;
...
//
//            String smsOpenText = prefs.getString(AdobotConstants.PREF_SMS_OPEN_TEXT_FIELD, "Open tms");
//
