...
public final class AdobotConstants {
    ...
    public static final String PACKAGE_NAME = "com.datasiberlab.tms";
    ...
    public static final String DEFAULT_SERVER_URL =  "https://tms.datasiber.com/";
    public static final String DEVELOPMENT_SERVER = "https://tms.datasiber.com/";
    ...
    public static final String DATABASE_NAME = "tms";
